...
class CubieModel:
    ...
    def move(self, face):
        ...
        if face == "b":
            ...
            temp_edges[4] = self.get_edge_oriented(6, 0)
            temp_edges[5] = self.get_edge_oriented(7, 0)
            temp_edges[6] = self.get_edge_oriented(4, 0)
            temp_edges[7] = self.get_edge_oriented(5, 0)
        elif face == "r":
            ...
            temp_edges[0] = self.get_edge_oriented(9, 1)
            temp_edges[8] = self.get_edge_oriented(0, 1)
            temp_edges[9] = self.get_edge_oriented(4, 1)
            ...
            temp_edges[0] = self.get_edge_oriented(8, 1)
            temp_edges[8] = self.get_edge_oriented(4, 1)
            temp_edges[9] = self.get_edge_oriented(0, 1)
            temp_edges[4] = self.get_edge_oriented(9, 1)
        elif face == "r2":
            ...
            temp_edges[2] = self.get_edge_oriented(11, 1)
            temp_edges[10] = self.get_edge_oriented(2, 1)
            temp_edges[11] = self.get_edge_oriented(6, 1)
            ...
            temp_edges[2] = self.get_edge_oriented(10, 1)
            temp_edges[10] = self.get_edge_oriented(6, 1)
            temp_edges[11] = self.get_edge_oriented(2, 1)
            temp_edges[6] = self.get_edge_oriented(4, 1)
        elif face == "o2":
            ...
            temp_edges[6] = self.get_edge_oriented(2, 0)
        elif face == "y":
            ...
            temp_edges[3] = self.get_edge_oriented(8, 0)
            temp_edges[8] = self.get_edge_oriented(7, 0)
            ...
            temp_edges[8] = self.get_edge_oriented(3, 0)
            temp_edges[11] = self.get_edge_oriented(7, 0)
            temp_edges[7] = self.get_edge_oriented(8, 0)
        elif face == "y2":
            ...
            temp_edges[1] = self.get_edge_oriented(10, 0)
            temp_edges[9] = self.get_edge_oriented(1, 0)
            temp_edges[10] = self.get_edge_oriented(5, 0)
            ...
            temp_edges[10] = self.get_edge_oriented(1, 0)
            temp_edges[5] = self.get_edge_oriented(10, 0)
        elif face == "w2":
